...
![路由切换至about时的 console](https://img-blog.csdnimg.cn/20200531171055261.png)

路由切换至home时的 console:
![路由切换至home时的 console](https://img-blog.csdnimg.cn/20200531171112390.png)
...
`v-if` 组件A:
![v-if 组件A](https://img-blog.csdnimg.cn/20200531171228198.png)
